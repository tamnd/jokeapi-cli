...
Most of these come down to network reality or how jokeapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jokeapi rate-limits like any public site. jokeapi already paces
...
Where a surface is gated, jokeapi reads a cookie or token you supply
...
`jokeapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jokeapi actually did
