...
func TestHostWiring(t *testing.T) {
	...
	if want := "jokeapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jokeapi", "about")
	if err != nil || got.String() != "jokeapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jokeapi://page/about", got.String(), err)
	}
}
